...
import { Scissors, AlertCircle, Settings2, KeyRound, FlaskConical } from 'lucide-react';
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-800">
          ...
          <div className="flex items-center gap-2">
            <button
               ...
               className={`p-2 rounded-lg transition-colors border ${appState === AppState.TESTING ? 'bg-indigo-500 text-white border-indigo-500' : 'text-slate-400 hover:text-indigo-400 hover:bg-slate-800 border-transparent'}`}
               title="테스트 모드 전환"
            >
